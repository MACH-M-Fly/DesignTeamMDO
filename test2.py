...
print("LOL", tail)
print("srsly", np.array([0,0,0,0]))

plot = plot_geo_final(M6.wing.Xle, M6.wing.Yle, M6.wing.chord_vals, \
	M6.tail.Xle_ht, M6.tail.Yle_ht, M6.tail.htail_chord_vals, 5, 4.5, 0)
